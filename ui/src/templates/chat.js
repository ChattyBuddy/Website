angular
  .module("elastichat", ["ionic", "monospaced.elastic", "angularMoment"])
  ...
  return (
    (a.prototype = {
      ...
      getTagBuilder: function () {
        ...
        return (
          b ||
            (b = this.tagBuilder = new a.AnchorTagBuilder({
      ...
      processTextNode: function (a) {
        var b = this;
        return a.replace(this.matcherRegex, function (
          a,
          c,
          d,
          e,
